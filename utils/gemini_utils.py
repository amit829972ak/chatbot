...
# Constants
GEMINI_TEXT_MODEL = "gemini-pro"  # For text-only queries
GEMINI_VISION_MODEL = "gemini-pro-vision"  # For queries with images
...
def get_gemini_client(api_key=None):
    ...
    # Configure the Gemini API with a retry mechanism
    try:
